"""
Export a PEFT/LoRA adapter checkpoint (e.g. `m1-checkpoint/`) into full merged `.safetensors`
weights that can be loaded by `Qwen2_5_VLForConditionalGenerationWithMemory`.

This script:
  1) loads the base model weights
